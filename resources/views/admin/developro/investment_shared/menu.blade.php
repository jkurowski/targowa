<div class="card-header card-nav">
    <nav class="nav">
        ...
        <a class="nav-link {{ Request::routeIs('admin.developro.investment.section.index') ? ' active' : '' }}" href="{{route('admin.developro.investment.section.index', $investment)}}"><span class="fe-file-text"></span> Sekcje tekstowe</a>
    </nav>
</div>
