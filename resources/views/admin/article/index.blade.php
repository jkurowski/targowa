                    ...
                    <table class="table mb-0">
                        ...
                        @foreach ($list as $item)
                            <tr id="recordsArray_{{ $item->id }}" class="list-category-{{$item->category_id}}">
                                ...
                                <td class="option-120">
                                    <div class="btn-group">
                                        <a href="https://developers.facebook.com/tools/debug/?q={{route('front.news.show', ['slug' => $item->slug])}}" target="_blank" class="btn action-button me-3" data-bs-toggle="tooltip" data-placement="top" data-bs-title="Facebook sharing debugger"><i class="fe-radio"></i></a>

                                        <a href="{{route('admin.article.edit', ['article' => $item->id, 'lang' => 'en'])}}" class="btn action-button lang-button me-1" data-toggle="tooltip" data-placement="top" title="Edytuj"><img src="{{ asset('/cms/flags/en.png') }}" alt="Tłumaczenie: en"></a>
